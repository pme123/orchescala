...
You find a version for a version for _Camunda 7_ and one for _Camunda 8_ on Github - see [Invoice Example](https://github.com/pme123/orchescala/tree/master/examples/invoice)

[Camunda 7 BPMN](https://github.com/pme123/orchescala/blob/master/examples/invoice/camunda7/src/main/resources/invoice.v2.bpmn)
...
Checkout the Domain Description of @:source(orchescala.examples.invoice.InvoiceReceipt).
