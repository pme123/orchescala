...
case class BpmnProcessGenerator(processType: BpmnProcessType)(using config: DevConfig):
  ...
  private def bpmnC8(setupElement: SetupElement) =
    val processId = setupElement.identifier
    s"""<?xml version="1.0" encoding="UTF-8"?>
       |<bpmn:definitions xmlns:bpmn="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:color="http://www.omg.org/spec/BPMN/non-normative/color/1.0" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:modeler="http://camunda.org/schema/modeler/1.0" xmlns:zeebe="http://camunda.org/schema/zeebe/1.0" xmlns:camunda="http://camunda.org/schema/1.0/bpmn" xmlns:conversion="http://camunda.org/schema/conversion/1.0" id="Definitions_0phxlok" targetNamespace="http://bpmn.io/schema/bpmn" exporter="Camunda Web Modeler" exporterVersion="047cf72" modeler:executionPlatform="Camunda Cloud" modeler:executionPlatformVersion="8.8.0" conversion:converterVersion="0.13.1">
       |  <bpmn:collaboration id="Collaboration_1nchi5w" isClosed="false">
       |    <bpmn:participant id="$processId-Participant" name="$processId" processRef="$processId" />
       |  </bpmn:collaboration>
       |  <bpmn:process id="$processId" name="$processId" processType="None" isClosed="false" isExecutable="true">
       |    <bpmn:extensionElements>
       |      <zeebe:versionTag value="1.0" />
       |    </bpmn:extensionElements>
       |    <bpmn:serviceTask id="InitProcessTask" name="Init Process" implementation="##WebService">
       |      <bpmn:extensionElements>
       ...
       |        <zeebe:ioMapping>
       |          <zeebe:output source="=&#34;output-mocked&#34;" target="processStatus" />
       |        </zeebe:ioMapping>
       |      </bpmn:extensionElements>
       |      <bpmn:incoming>Flow_0vdwlr8</bpmn:incoming>
       |    </bpmn:endEvent>
       ...
       |        <dc:Bounds x="392" y="319" width="36" height="36" />
       |        <bpmndi:BPMNLabel>
       |          <dc:Bounds x="433" y="353" width="73" height="14" />
       |        </bpmndi:BPMNLabel>
       |      </bpmndi:BPMNShape>
       |      <bpmndi:BPMNEdge id="Flow_1jqb7g9_di" bpmnElement="Flow_1jqb7g9">
       |        <di:waypoint x="258" y="297" />
