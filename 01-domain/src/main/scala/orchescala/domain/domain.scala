...
inline def deriveSeqApiSchema[T](using
  ...
  Schema.derived[T].asIterable[Seq]
...
object JsonProperty:
  given InOutCodec[JsonProperty] = deriveCodec
...
// descriptions
val deprecatedDescr                       =
  "See https://pme123.github.io/orchescala/specification.html#supported-general-variables"
